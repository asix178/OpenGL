...
//        
//vec3 FinalLightResult = ambient + diffuse + specular;
//
...
//        //szeœcian
//
//        glm::mat4 modelMat = glm::translate(glm::mat4(1.0f), glm::vec3(0.0 + move.x, -2.0f + move.y, 0.0 - move.z));
...
//
//        glUniform3f(glGetUniformLocation(shaderProgram, "object_mat.ambient"), 0.01f, 0.01f, 0.01f);  // object ambient
//        glUniform3f(glGetUniformLocation(shaderProgram, "object_mat.diffuse"), 0.7f + 0.3f * glm::sin(glfwGetTime()), 0.01f, 0.01f);  // object diffuse
//        glUniform3f(glGetUniformLocation(shaderProgram, "object_mat.specular"), 0.5f, 0.3f, 0.3f);  // object specular
//        glUniform1f(glGetUniformLocation(shaderProgram, "object_mat.shininess"), 50 + 30 * glm::sin(glfwGetTime()));  // object shininess
//
//        glUseProgram(shaderProgram);
//        glBindVertexArray(VertexArrayId);
